...
static const double DEN[MWSPT_NSEC][3] = {
  ...
  {
                   1,   -1.997977255788,   0.9979842193554
  },
  {
                   1,                 0,                 0
  }
...
qFilterIIR_HP025::qFilterIIR_HP025() :
    qAbstractFilter (0)
{
    privInit();
}

void qFilterIIR_HP025::InitLead(int lead)
{
...
void qFilterIIR_HP025::privInit()
{
    memset(x, 0, sizeof(x));
    memset(y, 0, sizeof(y));
}

int32_t qFilterIIR_HP025::privFilter(int32_t sample, int lead)
{
#if 0
    uint16_t i;
    x[lead][0][0] = sample;
