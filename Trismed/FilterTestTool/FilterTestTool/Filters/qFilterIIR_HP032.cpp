...
static const double DEN[MWSPT_NSEC][3] = {
  ...
  {
                   1,    -1.99740912435,    0.997420530239
  },
  {
                   1,                 0,                 0
  }
...
qFilterIIR_HP032::qFilterIIR_HP032() :
    qAbstractFilter(0)
{
    privInit();
}

void qFilterIIR_HP032::InitLead(int lead)
{
...
void qFilterIIR_HP032::privInit()
{
    memset(x, 0, sizeof(x));
    memset(y, 0, sizeof(y));
}

int32_t qFilterIIR_HP032::privFilter(int32_t sample, int lead)
{
#if 0
    uint16_t i;
    x[lead][0][0] = sample;
