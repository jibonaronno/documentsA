...
static const double DEN[MWSPT_NSEC][3] = {
  ...
  {
                   1,   -1.995944682872,   0.9959725090869
  },
  {
                   1,                 0,                 0
  }
...
qFilterIIR_HP05::qFilterIIR_HP05() :
    qAbstractFilter(0)
{
    privInit();
}

void qFilterIIR_HP05::InitLead(int lead)
{
...
void qFilterIIR_HP05::privInit()
{
    memset(x, 0, sizeof(x));
    memset(y, 0, sizeof(y));
}

int32_t qFilterIIR_HP05::privFilter(int32_t sample, int lead)
{
#if 0
    uint16_t i;
    x[lead][0][0] = sample;
