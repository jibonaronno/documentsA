...
static const double DEN[MWSPT_NSEC][3] = {
  ...
  {
                   1,   -1.998787535204,   0.9987900430999
  },
  {
                   1,                 0,                 0
  }
...
qFilterIIR_HP015::qFilterIIR_HP015() :
    qAbstractFilter(0)
{
    privInit();
}

void qFilterIIR_HP015::InitLead(int lead)
{
...
void qFilterIIR_HP015::privInit()
{
    memset(x, 0, sizeof(x));
    memset(y, 0, sizeof(y));
}

int32_t qFilterIIR_HP015::privFilter(int32_t sample, int lead)
{
#if 0
    uint16_t i;
    x[lead][0][0] = sample;
