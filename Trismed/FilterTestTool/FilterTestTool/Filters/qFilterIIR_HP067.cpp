...
static const double DEN[MWSPT_NSEC][3] = {
  ...
  {
                   1,   -1.994556939921,   0.9946068704706
  },
  {
                   1,                 0,                 0
  }
...
qFilterIIR_HP067::qFilterIIR_HP067() :
    qAbstractFilter(0)
{
    privInit();
}

void qFilterIIR_HP067::InitLead(int lead)
{
...
void qFilterIIR_HP067::privInit()
{
    memset(x, 0, sizeof(x));
    memset(y, 0, sizeof(y));
}

int32_t qFilterIIR_HP067::privFilter(int32_t sample, int lead)
{
#if 0
    uint16_t i;
    x[lead][0][0] = sample;
