...
#define DEMO_BULLET_SIZE (15)

static lv_style_t style_bullet;
static lv_obj_t *scale1;
static const lv_font_t *font_normal = &lv_font_montserrat_20;

static lv_obj_t *create_scale_box(lv_obj_t *parent, char *text1, const char *text2, const char *text3)
{
    lv_obj_t *scale = lv_scale_create(parent);
    lv_obj_center(scale);
    lv_obj_set_size(scale, LV_HOR_RES, LV_HOR_RES);
    ...
    lv_obj_set_size(bullet1, DEMO_BULLET_SIZE, DEMO_BULLET_SIZE);
    ...
    lv_obj_set_size(bullet2, DEMO_BULLET_SIZE, DEMO_BULLET_SIZE);
    ...
    lv_obj_set_size(bullet3, DEMO_BULLET_SIZE, DEMO_BULLET_SIZE);
    ...
    static int32_t grid_col_dsc[] = {LV_GRID_CONTENT, LV_GRID_CONTENT, LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
    ...
    lv_obj_set_grid_cell(scale, LV_GRID_ALIGN_START, 0, 3, LV_GRID_ALIGN_START, 1, 1);
    lv_obj_set_grid_cell(bullet1, LV_GRID_ALIGN_START, 1, 1, LV_GRID_ALIGN_CENTER, 2, 1);
    lv_obj_set_grid_cell(bullet2, LV_GRID_ALIGN_START, 1, 1, LV_GRID_ALIGN_CENTER, 3, 1);
    lv_obj_set_grid_cell(bullet3, LV_GRID_ALIGN_START, 1, 1, LV_GRID_ALIGN_CENTER, 4, 1);
    lv_obj_set_grid_cell(label1, LV_GRID_ALIGN_STRETCH, 2, 1, LV_GRID_ALIGN_START, 2, 1);
    lv_obj_set_grid_cell(label2, LV_GRID_ALIGN_STRETCH, 2, 1, LV_GRID_ALIGN_START, 3, 1);
    lv_obj_set_grid_cell(label3, LV_GRID_ALIGN_STRETCH, 2, 1, LV_GRID_ALIGN_START, 4, 1);
    return scale;
}
