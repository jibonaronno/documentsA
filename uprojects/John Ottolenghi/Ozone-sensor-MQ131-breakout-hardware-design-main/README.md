...
| ![Ozone sensor MQ131 breakout Image](https://solde.red/333110/image) |
| :----------------------------------------------------------: |
...
This repository contains all design files for Ozone sensor MQ131 breakout, organized as follows:
