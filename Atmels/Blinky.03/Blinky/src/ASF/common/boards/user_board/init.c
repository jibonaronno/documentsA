...
void board_init(void)
{
	...
	gpio_configure_pin(PIO_PA24_IDX, PIN_USART1_SPI_NSS_FLAGS);
	
	// gpio_configure_pin(PIO_PA23A_SCK1, PIN_USART1_SPI_SCK_FLAGS);
	// gpio_configure_pin(PIO_PA24A_RTS1, PIN_USART1_SPI_NSS_FLAGS);
